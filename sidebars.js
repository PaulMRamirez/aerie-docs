          ...
          items: [
            {
              ...
              items: [
                ...
                'overview/design/arch-decision-records/adr-0101-plandev-actions',
              ],
            },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          type: 'link',
          href: 'https://github.com/PlanDev/plandev/blob/develop/deployment/Environment.md',
        },
          ...
          items: [
            {
              ...
              items: [
                ...
                'scheduling-and-constraints/declarative/constraints/examples',
                {
                  label: 'EDSL Docs',
                  type: 'link',
                  href: 'https://plandev.github.io/plandev/constraints-edsl-api/',
                },
              ],
            },
            {
              ...
              items: [
                ...
                'scheduling-and-constraints/declarative/scheduling/temporal-subset',
                {
                  label: 'EDSL Docs',
                  type: 'link',
                  href: 'https://plandev.github.io/plandev/scheduling-edsl-api/modules/Scheduling_eDSL.html',
                },
              ],
            },
          ],
    ...
    },
    {
      ...
      items: [
        ...
        'sequencing/seqn',
        {
          ...
          type: 'link',
          href: 'https://github.com/PlanDev/seq-json-schema',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/constraints/',
        },
        {
          label: 'Contrib',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/contrib/',
        },
        {
          label: 'Examples - Banananation',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/examples/banananation/',
        },
        {
          label: 'Examples - Config With Defaults',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/examples/config-with-defaults/',
        },
        {
          label: 'Examples - Config Without Defaults',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/examples/config-without-defaults/',
        },
        {
          label: 'Examples - Foo Mission Model',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/examples/foo-missionmodel/',
        },
        {
          label: 'Merlin Driver',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/merlin-driver/',
        },
        {
          label: 'Merlin Framework',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/merlin-framework/',
        },
        {
          label: 'Merlin Framework JUnit',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/merlin-framework-junit/',
        },
        {
          label: 'Merlin Framework Processor',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/merlin-framework-processor/',
        },
        {
          label: 'Merlin SDK',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/merlin-sdk/',
        },
        {
          label: 'Merlin Server',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/merlin-server/',
        },
        {
          label: 'Merlin Worker',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/merlin-worker/',
        },
        {
          label: 'Parsing Utilities',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/parsing-utilities/',
        },
        {
          label: 'Procedural APIs',
          type: 'link',
          href: 'https://plandev.github.io/plandev/procedural-apis',
        },
        {
          label: 'Scheduler Driver',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/scheduler-driver/',
        },
        {
          label: 'Scheduler Server',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/scheduler-server/',
        },
        {
          label: 'Scheduler Worker',
          type: 'link',
          href: 'https://plandev.github.io/plandev/javadoc/scheduler-worker/',
        },
      ],
    },
    'glossary',

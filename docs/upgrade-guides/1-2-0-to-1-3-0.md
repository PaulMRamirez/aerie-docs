...
## Remove Nested Seq JSON GraphQL Querying ([#716](https://github.com/PlanDev/plandev/pull/716))

To query the PlanDev GraphQL API for Seq JSON we provide the following four queries:

...
An example implementation of a `duplicate()` method on a task can be found in PlanDev's `ReplayingTask` class, [located here](https://github.com/PlanDev/plandev/blob/develop/merlin-framework/src/main/java/gov/nasa/jpl/aerie/merlin/framework/ReplayingTask.java#L75).

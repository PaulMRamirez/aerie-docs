...
### Activity Directive New Primary Key ([#380](https://github.com/PlanDev/plandev/pull/380))
...
### Improved Test Ergonomics ([#382](https://github.com/PlanDev/plandev/pull/382))
...
Please reference [this diff](https://github.com/PlanDev/plandev/commit/de36ac4983dbc830b3691077439758fdd0491eee#diff-d2f70599d51fd583111cde71d52820ccaec50abc4d13ae62c30e5ae10b97d8b9) which makes these updates to one of our example mission models.

### Move 'TaskFactory' from Framework to Protocol ([#382](https://github.com/PlanDev/plandev/pull/382))
...
```java
dev.plandev.merlin.framework.Context.TaskFactory
```

Need to change to:

```java
dev.plandev.merlin.protocol.model.TaskFactory
```

### Remove 'RootModel' ([#382](https://github.com/PlanDev/plandev/pull/382))
...
### Update Constraint Boolean Operator Names ([#407](https://github.com/PlanDev/plandev/pull/407))
...
### SimulationResults Java Class No Longer Provides 'resourceSamples' Field ([#423](https://github.com/PlanDev/plandev/pull/423))
...
### Rename 'command-expansion-server' to 'sequencing-server' ([#439](https://github.com/PlanDev/plandev/pull/439))

To better align with the domain of PlanDev sequencing features (command expansion, sequence authoring, command dictionary management, etc.) the `plandev-commanding` image was renamed to `plandev-sequencing`. Any downstream deployment configuration that was using `plandev-commanding` needs to be updated to reference the new [plandev-sequencing image](https://github.com/PlanDev/plandev/pkgs/container/plandev-sequencing). You can reference the updated deployment [docker-compose.yml](https://github.com/PlanDev/plandev/blob/develop/deployment/docker-compose.yml#L102) for a detailed example.

### Add Scheduler Workers ([#406](https://github.com/PlanDev/plandev/pull/406))

A scheduler worker has been added that allows for running multiple concurrent scheduling jobs. You need to make sure any downstream deployment configurations now use at least one [plandev-scheduler-worker image](https://github.com/PlanDev/plandev/pkgs/container/plandev-scheduler-worker). You can reference the updated deployment [docker-compose.yml](https://github.com/PlanDev/plandev/blob/develop/deployment/docker-compose.yml#L81) for a detailed example. Also please read the updated [PlanDev Scheduler](https://github.com/PlanDev/plandev/blob/develop/deployment/Environment.md#plandev-scheduler) and [PlanDev Scheduler Worker](https://github.com/PlanDev/plandev/blob/develop/deployment/Environment.md#plandev-scheduler-worker) environment variables to make sure your deployment is up-to-date.

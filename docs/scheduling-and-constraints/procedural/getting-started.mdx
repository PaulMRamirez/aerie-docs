...
We have created a template repository for your mission model, scheduling procedures, and constraint procedures [here](https://github.com/PlanDev/plandev-mission-model-template).
...
3. Copy the `build.gradle` from the `scheduling` and `constraints` subprojects of the [mission model template repo](https://github.com/PlanDev/plandev-mission-model-template).
...
See some examples in the [mission model template repo](https://github.com/PlanDev/plandev-mission-model-template), the PlanDev [mission model tutorial](https://github.com/PlanDev/plandev-modeling-tutorial), or see the procedural [constraints page](../constraints/introduction) of the docs.

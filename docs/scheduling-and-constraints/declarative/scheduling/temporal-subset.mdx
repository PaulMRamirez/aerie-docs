...
First, you’ll need to define a numeric resource in your mission model that represents time - for example, you could use a [Clock](https://github.com/PlanDev/plandev/blob/develop/contrib/src/main/java/gov/nasa/jpl/aerie/contrib/models/Clock.java).

...
Here we describe how to edit the timeline using the [PlanDev UI](https://github.com/PlanDev/plandev-ui). For more details on the full timeline definition please refer to the [UI Views](./ui-views.md#timeline) documentation.

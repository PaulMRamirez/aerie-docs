...
Here we describe the timeline rendering and interaction options that are not part of the PlanDev UI View. Above the timeline is a tray of icon buttons that can be used to control how data is rendered and interacted with on the timeline.

<figure>
  <img alt="PlanDev UI - Timeline Icon Tray" src={timelineIconTray} />
  <figcaption>Figure 1: PlanDev UI - Timeline Icon Tray</figcaption>
</figure>

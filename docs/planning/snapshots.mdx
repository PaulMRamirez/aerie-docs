...
<figure>
  <div>
    <img alt="PlanDev UI - Expanded drop down under Plan in the Navbar, the option 'Take Snapshot' is highlighted" src={takeSnapshotNavbar}/>
  </div>
  <img alt="PlanDev UI - Take Snapshot Modal" src={takeSnapshotModal}/>
  <figcaption>Figure 1: PlanDev UI - How to Take a Plan Snapshot</figcaption>
</figure>
...
<figure>
  <div>
    <img alt="PlanDev UI - Expanded drop down under Plan in the Navbar, the option 'View Snapshot' is highlighted" src={viewSnapshotNavbar}/>
  </div>
  <img alt="PlanDev UI - Plan Metadata Pane" src={planMetadataPane}/>
  <figcaption>Figure 2: PlanDev UI - How to View a Plan Snapshot</figcaption>
</figure>
...
<figure>
  <img alt="PlanDev UI - Take Snapshot Modal" src={viewSnapshot}/>
  <figcaption>Figure 3: PlanDev UI - Viewing a Plan Snapshot</figcaption>
</figure>
...
<figure>
  <div>
    <img alt="PlanDev UI - Restore Snapshot Modal" src={restoreSnapshotModal}/>
  </div>
  <img alt="PlanDev UI - Restore and Take Snapshot Modal - Simple" src={restoreAndTakeSnapshot}/>
  <figcaption>Figure 4: PlanDev UI - How to Restore a Plan Snapshot</figcaption>
</figure>

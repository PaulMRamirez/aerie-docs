...
Below is a basic example that sets the additional time formats to a single format that displays the current UTC year. For additional plugin examples, please refer to the [plandev-ui-plugin-examples](https://github.com/PlanDev/plandev-ui-plugin-examples) repository.

...
PlanDev is a software framework for modeling spacecraft. Within PlanDev is **Merlin**, a mission modeling environment and hybrid system simulator based on the [Java programming language](<https://en.wikipedia.org/wiki/Java_(programming_language)>).

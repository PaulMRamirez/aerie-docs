...
This page will go over one way to do so, using a simplified version of [the Banananation model](https://github.com/PlanDev/plandev/tree/develop/examples/banananation) as a reference.

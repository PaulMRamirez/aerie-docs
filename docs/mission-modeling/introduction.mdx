...
or check out our [GitHub template mission model repository](https://github.com/PlanDev/plandev-mission-model-template) for an empty template.
You will need a public [GitHub.com](https://github.com/) account to download the PlanDev Maven packages.

If you do not want to develop a mission model and just want to try an example, you can download the [missionmodel.jar](https://github.com/PlanDev/plandev-modeling-tutorial/blob/main/missionmodel.jar) from the [PlanDev modeling tutorial repository](https://github.com/PlanDev/plandev-modeling-tutorial).
...
<RemoteCodeBlock
  ...
  url="https://raw.githubusercontent.com/PlanDev/plandev-mission-model-template/main/missionmodel/src/main/java/missionmodel/package-info.java"
></RemoteCodeBlock>
...
<RemoteCodeBlock
  ...
  url="https://raw.githubusercontent.com/PlanDev/plandev-mission-model-template/main/missionmodel/src/main/java/missionmodel/Mission.java"
></RemoteCodeBlock>

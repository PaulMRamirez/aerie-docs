...
The adaptation type is defined in [Sequencing](https://github.com/PlanDev/plandev-ui/blob/develop/src/types/sequencing.ts#L70) and [Extension Points](https://github.com/PlanDev/plandev-ui/blob/develop/src/utilities/sequence-editor/extension-points.ts)

...
First, we must upload the schema we created for the External Source Type & the two External Event Types. In the PlanDev UI, navigate to the External Sources page:

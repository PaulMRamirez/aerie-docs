...
## Creating an External Source
We are going to manually create two External Source json files, and in the next section we will upload them to PlanDev. The Sources will be slightly staggered in the times they cover to help us later in illustrating how derivation works.
...
We are now ready to upload our test External Source files to PlanDev!

...
## API Gateway
External Events & their respective External Sources utilize routes located on [`plandev-gateway`](https://github.com/PlanDev/plandev-gateway) to perform data validation and upon success, an upload through Hasura/GQL.
